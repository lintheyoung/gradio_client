    ...
    def predict(
        ...
        *args,
        ...
        Example:
            ...
            >> 9.0
        """
        self.job = self.submit(*args, api_name=api_name, fn_index=fn_index)
...
class Job(Future):
    ...
    def __init__(
        ...
        if self.verbose:
            print(f"Job created with space_id: {self.space_id}")
        ...
        if self.communicator:
            ...
            while True:
                ...
                with self.communicator.lock:
                    if self.communicator.job.outputs:
                        return self.communicator.job.outputs[0]
                # print(self.communicator.job.outputs)
                # print(datetime.now())
                time.sleep(0.01)
        else:
        ...
        if self.done():
            ...
            if not self.communicator:
                ...
                with self.communicator.lock:
                    ...
                    # print(self.communicator.job.latest_status)
